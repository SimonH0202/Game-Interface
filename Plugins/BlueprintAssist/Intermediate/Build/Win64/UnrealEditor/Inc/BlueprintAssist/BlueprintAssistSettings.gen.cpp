...
template<> BLUEPRINTASSIST_API UScriptStruct* StaticStruct<FBAFormatterSettings>()
{
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_NumberOfNodesRequiredToShowOverlay_MetaData[];
#endif
		static const UECodeGen_Private::FUnsizedIntPropertyParams NewProp_NumberOfNodesRequiredToShowOverlay;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBASettings_Statics::NewProp_NumberOfNodesRequiredToShowOverlay_MetaData[] = {
		{ "Category", "Accessibility" },
		{ "Comment", "/* Number of pending caching nodes required to show overlay */" },
		{ "EditCondition", "bShowOverlayWhenCachingNodes" },
		{ "ModuleRelativePath", "Public/BlueprintAssistSettings.h" },
		{ "ToolTip", "Number of pending caching nodes required to show overlay" },
	};
#endif
	const UECodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UClass_UBASettings_Statics::NewProp_NumberOfNodesRequiredToShowOverlay = { "NumberOfNodesRequiredToShowOverlay", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UBASettings, NumberOfNodesRequiredToShowOverlay), METADATA_PARAMS(Z_Construct_UClass_UBASettings_Statics::NewProp_NumberOfNodesRequiredToShowOverlay_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UBASettings_Statics::NewProp_NumberOfNodesRequiredToShowOverlay_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UBASettings_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBASettings_Statics::NewProp_NumberOfNodesRequiredToShowOverlay,
	};
	...
	struct Z_CompiledInDeferFile_FID_Game_Interface_Plugins_BlueprintAssist_Source_BlueprintAssist_Public_BlueprintAssistSettings_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Game_Interface_Plugins_BlueprintAssist_Source_BlueprintAssist_Public_BlueprintAssistSettings_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Game_Interface_Plugins_BlueprintAssist_Source_BlueprintAssist_Public_BlueprintAssistSettings_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Game_Interface_Plugins_BlueprintAssist_Source_BlueprintAssist_Public_BlueprintAssistSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UBASettings, UBASettings::StaticClass, TEXT("UBASettings"), &Z_Registration_Info_UClass_UBASettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBASettings), 1048437255U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Game_Interface_Plugins_BlueprintAssist_Source_BlueprintAssist_Public_BlueprintAssistSettings_h_4038210633(TEXT("/Script/BlueprintAssist"),
		Z_CompiledInDeferFile_FID_Game_Interface_Plugins_BlueprintAssist_Source_BlueprintAssist_Public_BlueprintAssistSettings_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Game_Interface_Plugins_BlueprintAssist_Source_BlueprintAssist_Public_BlueprintAssistSettings_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Game_Interface_Plugins_BlueprintAssist_Source_BlueprintAssist_Public_BlueprintAssistSettings_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Game_Interface_Plugins_BlueprintAssist_Source_BlueprintAssist_Public_BlueprintAssistSettings_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_Game_Interface_Plugins_BlueprintAssist_Source_BlueprintAssist_Public_BlueprintAssistSettings_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Game_Interface_Plugins_BlueprintAssist_Source_BlueprintAssist_Public_BlueprintAssistSettings_h_Statics::EnumInfo));
