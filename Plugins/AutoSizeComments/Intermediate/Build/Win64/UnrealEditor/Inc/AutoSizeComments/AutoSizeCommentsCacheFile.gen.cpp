...
template<> AUTOSIZECOMMENTS_API UScriptStruct* StaticStruct<FASCCacheData>()
{
	...
	struct Z_CompiledInDeferFile_FID_Game_Interface_Plugins_AutoSizeComments_Source_AutoSizeComments_Public_AutoSizeCommentsCacheFile_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Game_Interface_Plugins_AutoSizeComments_Source_AutoSizeComments_Public_AutoSizeCommentsCacheFile_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Game_Interface_Plugins_AutoSizeComments_Source_AutoSizeComments_Public_AutoSizeCommentsCacheFile_h_1549659796(TEXT("/Script/AutoSizeComments"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Game_Interface_Plugins_AutoSizeComments_Source_AutoSizeComments_Public_AutoSizeCommentsCacheFile_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Game_Interface_Plugins_AutoSizeComments_Source_AutoSizeComments_Public_AutoSizeCommentsCacheFile_h_Statics::ScriptStructInfo),
		nullptr, 0);
